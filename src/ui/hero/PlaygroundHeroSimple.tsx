...
const sanitizeState = <T,>(value: T, depth = 0, seen = new WeakSet<object>()): T => {
  ...
  if (Array.isArray(value)) {
    return value.map((item) => sanitizeState(item, depth + 1, seen)) as T;
  }

  const sanitized = {} as T;
  for (const key in value) {
    if (Object.prototype.hasOwnProperty.call(value, key)) {
      sanitized[key] = sanitizeState(value[key], depth + 1, seen);
    }
  }
...
export function PlaygroundHeroSimple() {
  ...
  return (
    ...
    >
      {/* 3D Canvas - Full screen, behind UI */}
        ...
        {SceneComponent && (
          <Canvas
            ...
            onCreated={(state) => {
              ...
              console.log('✅ Simple Canvas created and visible!');
            }}
          >
